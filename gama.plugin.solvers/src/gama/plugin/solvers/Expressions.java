...
public class Expressions {
	...
	@operator (value = "+", category = { SolverUtils.CATEGORY }, concept = { IConcept.OPTIMIZATION })
	...
	@operator (value = "mod", category = { SolverUtils.CATEGORY }, concept = { IConcept.OPTIMIZATION })
	...
	@operator (value = "same", category = { SolverUtils.CATEGORY }, concept = { IConcept.OPTIMIZATION })
	...
	@operator (value = "as_table", category = { SolverUtils.CATEGORY }, concept = { IConcept.OPTIMIZATION })
	...
	public static GamaConstraint asTable(final IScope scope, final GamaConstraint constraint)
		...
		SolverUtils.requireConstraintEngine(scope, constraint.getProblem(), "as_table", null);
